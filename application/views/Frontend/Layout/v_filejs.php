...
<script src="<?= base_url('assets/porto/'); ?>vendor/popper/umd/popper.min.js"></script>
...
<script src="<?= base_url('assets/porto/'); ?>vendor/jquery.validation/jquery.validate.min.js"></script>
<script src="<?= base_url('assets/porto/'); ?>vendor/jquery.easy-pie-chart/jquery.easypiechart.min.js"></script>
...
<script src="<?= base_url('assets/porto/'); ?>vendor/vide/jquery.vide.min.js"></script>
<script src="<?= base_url('assets/porto/'); ?>vendor/vivus/vivus.min.js"></script>
...
<!-- Current Page Vendor and Views -->
<script src="<?= base_url('assets/porto/'); ?>js/views/view.contact.js"></script>

<!-- Demo -->
<script src="<?= base_url('assets/porto/'); ?>js/demos/demo-business-consulting.js"></script>
